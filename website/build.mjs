...
for(const file of ['index.html','instrument.png','credits.html','about.html','original-icon.png','hip-software.png','manual-cover.png'])await cp(`website/${file}`,`dist/site/${file}`);
