...
it('renders all sampled sounds, including melodic MIDI channel ten, within requested sample spans',async()=>{
 const p=new Palette(),b=readFileSync('docs/assets/soundfonts/harmony-palette.sf2');await p.load(b.buffer.slice(b.byteOffset,b.byteOffset+b.byteLength),48000);
