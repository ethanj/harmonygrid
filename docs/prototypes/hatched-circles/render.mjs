...
try{
 ...
 await send('Page.navigate',{url:'http://127.0.0.1:5173/docs/prototypes/hatched-circles/'});await pause(800);
 await writeFile(join(root,'preview.png'),Buffer.from((await send('Page.captureScreenshot',{format:'png',captureBeyondViewport:false})).data,'base64'));
