...
try{
 ...
 for(const [width,height] of [[1280,800],[1600,1000]])for(const scene of ['default','routing','preserve','external','capture','invalid','variations']){
 await send('Emulation.setDeviceMetricsOverride',{width,height,deviceScaleFactor:1,mobile:false});
 await send('Page.navigate',{url:new URL('index.html?scene='+scene,import.meta.url).href});await pause(150);
